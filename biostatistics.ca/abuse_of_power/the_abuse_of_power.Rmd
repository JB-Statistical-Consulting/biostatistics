...
[Download the R Markdown notebook here]() used to generate this blog post and practice your R skills for free!
```{r setup, echo = FALSE, warning=FALSE}
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE)
path <- "C:/Users/justi/Documents/GitHub/Content/power"
setwd(path)
